...
// Función para cargar vehículos en el modal de actualización
...
// Función para mostrar vehículos en la búsqueda de actualización - MEJORADA
function mostrarVehiculosEnBusquedaActualizar(vehiculos) {
    ...
    if (!vehiculos || vehiculos.length === 0) {
        contenedor.innerHTML = `
            <div class="mensaje-vacio-eliminar">
                ...
                <small>Agrega vehículos desde el botón "Agregar Nuevo Vehículo"</small>
            </div>
        `;
        return;
    }
    ...
    console.log(`✅ ${vehiculos.length} vehículos mostrados en búsqueda`);
}
