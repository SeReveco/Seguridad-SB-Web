...
function cerrarModalVehiculo() {
    ...
    vehiculoEditando = null;
            ...
            window.agregarNuevoTipoVehiculo = function () {
                console.log("🎯 agregarNuevoTipoVehiculo (EMERGENCIA) ejecutada");

                Swal.fire({
                    title: 'Agregar Nuevo Tipo de Vehículo',
                    input: 'text',
                    inputLabel: 'Nombre del tipo de vehículo',
                    inputPlaceholder: 'Ej: Automóvil, Motocicleta, Camioneta...',
                    ...
                    if (result.isConfirmed) {
                        console.log("📝 Nuevo tipo a guardar:", result.value);
                        // Aquí puedes agregar el código para guardar
                        Swal.fire({
                            icon: 'success',
                            title: '¡Éxito!',
                            text: `Tipo "${result.value}" se guardaría en la base de datos`,
                            confirmButtonColor: '#28a745'
                        });
                    }
                });
